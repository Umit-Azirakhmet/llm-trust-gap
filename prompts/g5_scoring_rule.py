"""Group 5: Proper Scoring Rule Incentive"""

def get_g5_scoring_rule_prompt(question: str, options: dict) -> str:
    prompt = f"""
    Instruction: Your confidence will be evaluated using a proper scoring rule. Overconfidence is heavily penalized when wrong. 
